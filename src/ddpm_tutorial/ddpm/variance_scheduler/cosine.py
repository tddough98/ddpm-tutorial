...
class CosineScheduler(Scheduler):  # noqa: D101
    ...
    def __init__(self, T: int, s: float = 0.008):
        ...
        self._alpha_hats_t_minus_1 = torch.roll(
            self._alpha_hats, shifts=1, dims=0
        )  # shift forward by 1 so that alpha_first[t] = alpha[t-1]
