...
def broadcast(values, broadcast_to):  # noqa: D103
...
def postprocess(images):  # noqa: D103
...
def create_sampling_animation(model, pipeline, config, interval=5, every_nth_image=1, rows=2, cols=3):  # noqa: D103
